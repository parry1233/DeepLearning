...
trainData_Dir = 'KaggleData/Cat_Dog/train'
...
testData_Dir = 'KaggleData/Cat_Dog/test1'
...
df.to_csv('cat_dog_prediction.csv',index = False)

sampleData_Dir = 'KaggleData/Cat_Dog/sample'
...
for i in range(len(sample_id)):
    ...
    filename = 'KaggleData/Cat_Dog/sample/'+str(sample_id[i])+'.jpg'
    print(filename)
    ...
    img.save('KaggleData/Cat_Dog/sample_output/'+str(sample_id[i])+'.png')